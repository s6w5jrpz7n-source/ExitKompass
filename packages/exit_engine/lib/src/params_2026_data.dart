/// Embedded copy of `lib/params/params_2026.json`.
///
/// GENERATED from the JSON file - do not edit by hand; edit
/// `lib/params/params_2026.json` and regenerate this file
/// (`tool/embed_params.py`). The test `params_sync_test.dart`
/// ensures both copies stay identical.
library;
